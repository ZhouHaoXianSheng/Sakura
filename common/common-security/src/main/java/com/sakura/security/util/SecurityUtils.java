package com.sakura.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public SakuraUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof SakuraUser) {
			return (SakuraUser) principal;
		}
		return null;
	}
